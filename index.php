...
<main>
    <section class="hero-section position-relative overflow-hidden" style="height: 100vh; background: #fff;">
        <div class="container position-relative z-3 h-100 d-flex align-items-center justify-content-center">
            <div class="text-center text-dark">
                <div class="service-content mb-5 mb-lg-0">
                    <span class="badge bg-primary rounded-pill px-3 py-2 mb-3 reveal-up">Our Expertise</span>
                    <h2 class="display-4 fw-bold text-dark mb-4 split">Enterprise Solutions <br><span class="text-primary-gradient">& Global Scale</span></h2>
                    <p class="lead text-muted mb-5 mx-auto split" style="max-width: 800px;">
                        We merge cognitive engineering with high-performance code to build digital products that lead markets.
                    </p>
    ...
    <section class="info-section">
        <div class="left-part">
            ...
            <a href="contact.php" class="book-link">
                ...
                <div class="col-sm-12 col-lg-10 text-center">
                    <div class="legacy-content p-5">
                        ...
                        <p class="display-6 text-dark fw-light reveal-up mb-4" style="line-height: 1.6; letter-spacing: -0.02em; font-size: 1.8rem;">
                            Established in 2024, MVSoft Solutions was born from a realization that high-quality code shouldn't be a luxury. We've scaled to over 500 successful project completions.
                        </p>
                        <p class="lead text-muted mb-5 reveal-up">
                            We believe in clean code, transparent pricing, and rapid delivery.
                        </p>
                        <div class="reveal-up">
                            <a href="contact.php" class="btn btn-primary btn-lg rounded-pill px-5 shadow-glow">Join Our Journey</a>
                        </div>
                    </div>
                </div>
            </div>
