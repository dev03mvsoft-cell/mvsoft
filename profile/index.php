...
<body>
    ...
    <nav class="profile-nav">
        <div class="nav-left">
            <div class="logo">MVSOFT</div>

        </div>
        <div class="nav-right">

            <a href="../" class="nav-link">Switch to Real World</a>
        </div>
    </nav>
    ...
    <main id="app">
        ...
        <section class="clients-showcase">
            <div class="showcase-header">
                <span class="magic-label">Portfolio</span>
                <h2 class="showcase-title">Our Valuable <span>Clients</span></h2>
            </div>
        ...
        <section class="trusted-section">
            <div class="container">
                ...
                <div class="trust-grid">
                    ...
                    <!-- National Reach -->
                    <div class="trust-card leaf-style">
                        <div class="trust-icon"><i class="fa-solid fa-earth-asia"></i></div>
                        <h3>Pan-India Operations</h3>
                        <p>Scaling excellence across the nation with a footprint that represents quality, trust, and advanced innovation.</p>
                    </div>
                </div>
                ...
                <div class="trust-stats-bar">
                    ...
                    <div class="t-stat">
                        <span class="t-count">100%</span>
                        <span class="t-label">Client Loyalty</span>
                    </div>
                    <div class="t-divider"></div>
                    <div class="t-stat">
